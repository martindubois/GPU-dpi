    ...
    OPEN_NET_FUNCTION_BEGIN
        ...
        if ( 0 != lIP )
        {
            ...
            case TCP_IP_PROTOCOL :
                if ( 0x0100 == TCP_DestinationPort( lIP ) ) { lR = 1; }
                else
                {
        ...
        if ( ! lR )
        {
            ...
            if ( 0 != lIP )
            {
                ...
                {
                case TCP_IP_PROTOCOL :
                    if ( 0x0300 == TCP_DestinationPort( lIP ) ) { lR = 1; }
                    else
                    {
                        if ( 0x0300 == TCP_SourcePort( lIP ) ) { lR = 1; }
                    }
                    break;
                case UDP_IP_PROTOCOL :
                    if ( 0x0300 == UDP_DestinationPort( lIP ) ) { lR = 1; }
                    else
                    {
                        if ( 0x0300 == UDP_SourcePort( lIP ) ) { lR = 1; }
                    }
                    break;
                }
            }
